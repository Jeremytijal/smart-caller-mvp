    ...
    return (
        <div className="page-container integrations-page">
            ...
            <div className="twilio-section">
                ...
                <div className="integrations-grid two-columns">
                    {/* SMS Webhook */}
                    <div className="integration-card compact">
                        ...
                        <p className="card-description">
                            URL à configurer dans Twilio Console → Phone Numbers → Messaging
                        </p>
                        <div className="webhook-url-box">
                            <code>{API_URL}/incoming-sms</code>
                            <button 
                                className="btn-copy-small"
                                onClick={() => copyToClipboard(`${API_URL}/incoming-sms`)}
                            >
                                <Copy size={14} />
                            </button>
                        </div>
                    ...
                    {/* WhatsApp Webhook */}
                    <div className="integration-card compact whatsapp">
                        <div className="card-header-row">
                        ...
                        <p className="card-description">
                            URL à configurer dans Twilio Console → Messaging → WhatsApp Sandbox
                        </p>
                        <div className="webhook-url-box">
                            <code>{API_URL}/incoming-whatsapp</code>
                            <button 
                                className="btn-copy-small"
                                onClick={() => copyToClipboard(`${API_URL}/incoming-whatsapp`)}
                            >
                                <Copy size={14} />
                            </button>
                        </div>
                        ...
                        >
                            ...
                            Configurer WhatsApp dans Twilio
                        </a>
                    </div>
                </div>
            </div>
